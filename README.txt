...
The python code I have sent is focused on cashflow data analysis and visualization. 
The exact function I would like you to look at is in Cashflow_functions.py, called Cash_flow_bar_stoch_avg_with_stack. 
The functions within this file are called through main.py, and require basic python libraries as detailed in requirements.txt. 
